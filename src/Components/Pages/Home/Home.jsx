...
export const Home = () => {
  return (
    <section className='flex flex-col lg:flex-row items-center justify-center gap-15 p-6 rounded-lg text-white m-8 lg:m-auto lg:mt-20'>
      ...
      <div className='text-center lg:text-left max-w-lg'>
        <h1 className='text-4xl font-bold mb-4 text-amber-300'>Hola, soy Lenis Alfonso</h1>
        <p>
